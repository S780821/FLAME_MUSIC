...
from FlameMusic import app, BOT_USERNAME
...
from FlameMusic.FlameMusicUtilities.tgcallsrun import queues
...
import os
from os import path
from FlameMusic import BOT_USERNAME
import asyncio
import yt_dlp
from FlameMusic.converter import converter
...
from FlameMusic.FlameMusicUtilities.helpers.inline import play_keyboard, audio_markup, search_markup, play_markup
...
async def on_stream_end(client: PyTgCalls, update: Update) -> None:
    ...
    try:
        ...
        if queues.is_empty(chat_id):
            ...
            finxx = (f"{f1}{f2}{f3}")
            if str(finxx) != "raw":  
                mystic = await app.send_message(chat_id, "Downloading Next FlameMusic From Playlist....")
