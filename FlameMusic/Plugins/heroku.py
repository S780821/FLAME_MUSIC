...
from FlameMusic.config import (HEROKU_API_KEY, HEROKU_APP_NAME, UPSTREAM_BRANCH,
                    UPSTREAM_REPO,LOG_GROUP_ID)
from FlameMusic import SUDOERS, app
from FlameMusic.FlameMusicUtilities.helpers.heroku import is_heroku, user_input
from FlameMusic.FlameMusicUtilities.helpers.paste import isPreviewUp  
from FlameMusic.FlameMusicUtilities.helpers.paste import paste as paste_queue
